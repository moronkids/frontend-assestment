                    ...
                    <div className="card myCard">
                        <div className="card-body my-card-body">
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-6 col-md-12 col-12">
                                    <p className="label-nominal-transaksi">{transaksi.nominal_transaksi_idr}</p>
                                </div>
                            </div>
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-6 col-md-12 col-12">
                                    ...
                                    <p className="label-content">{transaksi.alamat_cust_lengkap}</p>
                                </div>
                            </div>
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-6 col-md-12 col-12">
                                    ...
                                    <p className="label-content status">{checkStatusAgen(transaksi.status)}</p>
                                </div>
                            </div>
                            ...
                            <div className="row">
                                <div className="col-lg-12 col-12">
                                    <button className={handleButtonClassName(transaksi.status)}>{handleTextButton(transaksi.status)}</button>
                                </div>
                            </div>
                        </div>
                    </div>
