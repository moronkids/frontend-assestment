          ...
          >
            ...
            <div className="row">
              <div className="col-lg-6 col-md-12 col-12">
                ...
                <p className="label-content">{data?.data?.[id]?.created_at}</p>
              </div>
              <div className="col-lg-6 col-md-12 col-12">
            ...
            <div className="row">
              ...
              <div className="col-lg-6 col-md-12 col-12">
                <p className="label-nominal-transaksi">
                  {data?.data?.[id]?.nominal_transaksi_idr}
                </p>
              </div>
            </div>
            ...
            <div className="row">
              ...
              <div className="col-lg-6 col-md-12 col-12">
                ...
                <p className="label-content">
                  {data?.data?.[id]?.customer?.alamat_cust_lengkap}
                </p>
              </div>
            </div>
            ...
            <div className="row">
              ...
              <div className="col-lg-6 col-md-12 col-12">
                ...
                <p className="label-content">
                  {data?.data?.[id]?.agen?.alamat_agen_lengkap}
                </p>
              </div>
            </div>
            {/* Baris Kontent */}
